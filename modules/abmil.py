...
class AB_MIL_Attention(nn.Module):
    def __init__(self, in_size, out_size, confounder_path=False, confounder_learn=False, \
        ...
        # self.tt = nn.Tanh()
        # self.linear2 = nn.Linear(in_size, 1)
