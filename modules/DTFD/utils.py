...
from sklearn.metrics import confusion_matrix, auc, roc_curve, roc_auc_score, precision_recall_fscore_support, accuracy_score, confusion_matrix,precision_score,recall_score,f1_score,classification_report
...
#
#     return accuracy, precision, recall, specificity, F1, auc, prob11

def eval_metric(bag_labels, bag_predictions):
    ...
    # auc_value = roc_auc_score(bag_labels, bag_predictions, average="micro")
    # this_class_label = np.array(bag_predictions)
    # this_class_label[this_class_label>=threshold_optimal] = 1
    # this_class_label[this_class_label<threshold_optimal] = 0
    # bag_predictions = this_class_label
    # precision, recall, fscore, _ = precision_recall_fscore_support(bag_labels, y_pred, average='micro')
